...
from src.framework.dataset_multiplesetting import *
...
trainer_LAURA.fit(model,
                  ...
                  ckpt_path=ckptmodel)
print("\n\nFIT DONE\n\n")
'''This method automatically loads the best weights from the previous training run, ensuring that 
   your predictions are based on the most optimized model state.'''
